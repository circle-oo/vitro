...
| Daikon | 1 whole |
| Fresh Eggs | 8 pcs |
`,b=m.useMemo(()=>h.filter(a=>t==="all"||a.category===t),[t,n]);return i.jsxs(i.Fragment,{children:[i.jsxs("div",{className:"demo-page-head",children:[i.jsxs("div",{children:[i.jsx("h2",{className:"demo-page-title",children:u("recipe.title")}),i.jsx("p",{className:"demo-page-subtitle",children:e("레시피 카드의 위계와 주간 계획 컨텍스트를 강화했습니다.","Recipe cards rebuilt with stronger visual hierarchy and quick planning context.","Cartes de recettes reconstruites avec une hiérarchie visuelle renforcée et un contexte de planification rapide.","レシピカードの階層と週間計画コンテキストを強化しました。")})]}),i.jsx(x,{variant:"primary",size:"sm",children:e("새 레시피","New recipe","Nouvelle recette","新規レシピ")})]}),i.jsx(v,{options:l.map(a=>a.label),value:((d=l.find(a=>a.id===t))==null?void 0:d.label)??l[0].label,onChange:a=>{const r=l.find(s=>s.label===a);r&&f(r.id)},className:"mb"}),i.jsxs("div",{className:"ben mb",children:[i.jsx("div",{className:"demo-grid-auto",children:b.map(a=>i.jsx("button",{type:"button",className:"demo-unstyled-button",onClick:()=>o==null?void 0:o(a.id),"aria-label":e(`${a.title} 상세`,`${a.title} detail`,`Détail ${a.title}`,`${a.title} 詳細`),children:i.jsxs(c,{hover:!1,padding:"none",children:[i.jsx("div",{className:"demo-recipe-image",style:{background:a.bg},children:a.emoji}),i.jsxs("div",{className:"demo-recipe-copy",children:[i.jsxs("div",{style:{display:"flex",justifyContent:"space-between",gap:"8px",alignItems:"center"},children:[i.jsxs("div",{children:[i.jsx("span",{style:{fontSize:"15px",fontWeight:700},children:a.title}),a.originalName&&a.originalName!==a.title&&i.jsx("span",{style:{fontSize:"11px",color:"var(--t3)",marginLeft:"6px"},children:a.originalName})]}),i.jsx("span",{className:"mono",style:{fontSize:"11px",color:"var(--t4)",flexShrink:0},children:a.time})]}),i.jsx("p",{style:{marginTop:"7px",marginBottom:0,fontSize:"12px",lineHeight:1.55,color:"var(--t3)"},children:a.summary}),i.jsxs("div",{style:{display:"flex",gap:"6px",marginTop:"10px"},children:[i.jsxs(g,{variant:"primary",size:"sm",children:[a.category==="italian"&&e("이탈리안","Italian","Italien","イタリアン"),a.category==="korean"&&e("한식","Korean","Coréen","韓国料理"),a.category==="french"&&e("프렌치","French","Français","フレンチ"),a.category==="japanese"&&e("일식","Japanese","Japonais","和食")]}),i.jsx(g,{variant:a.level===e("어려움","Hard","Difficile","上級")?"danger":a.level===e("보통","Medium","Moyen","普通")?"warning":"info",size:"sm",children:a.level})]})]})]})},a.id))}),i.jsxs(c,{hover:!1,children:[i.jsx("div",{className:"demo-card-title",children:e("주간 플래너","Weekly planner","Planificateur hebdomadaire","週間プランナー")}),i.jsx(k,{content:p})]})]})]})}export{F as RecipesPage};
