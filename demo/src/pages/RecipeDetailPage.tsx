...
3. Toss aggressively and finish`,
    markdownFr: `## Points clés
...
3. Mélanger vivement et terminer`,
    markdownJa: `## 重要ポイント
...
3. 強くトスして仕上げる`,
    ingredients: [
      { id: 'r1-pasta', ko: '스파게티 180g', en: 'Spaghetti 180g', fr: 'Spaghetti 180g', ja: 'スパゲッティ 180g' },
      { id: 'r1-pec', ko: '페코리노 90g', en: 'Pecorino 90g', fr: 'Pecorino 90g', ja: 'ペコリーノ 90g' },
      { id: 'r1-pepper', ko: '흑후추 1.5T', en: 'Black pepper 1.5T', fr: 'Poivre noir 1,5 c.s.', ja: '黒胡椒 1.5T' },
    ],
    relatedSessionId: 'c1',
    relatedToolId: 't3',
  },
  r2: {
    titleKo: '연어 사시미 + 다이콘',
    titleEn: 'Salmon Sashimi + Daikon',
    titleFr: 'Sashimi de saumon + Daikon',
    titleJa: 'サーモン刺身 + 大根',
...
- 最後にレモンゼスト`,
    ingredients: [
      { id: 'r2-salmon', ko: '연어 사쿠 200g', en: 'Salmon saku 200g', fr: 'Saumon saku 200g', ja: 'サーモン柵 200g' },
      { id: 'r2-radish', ko: '무 1/2개', en: 'Daikon 1/2', fr: 'Daikon 1/2', ja: '大根 1/2本' },
      { id: 'r2-lemon', ko: '레몬 1/2개', en: 'Lemon 1/2', fr: 'Citron 1/2', ja: 'レモン 1/2個' },
    ],
    relatedSessionId: 'c2',
    relatedToolId: 't2',
  },
...
3. 最後にネギと唐辛子`,
    ingredients: [
      { id: 'r3-paste', ko: '된장 2T', en: 'Doenjang 2T', fr: 'Doenjang 2 c.s.', ja: 'テンジャン 2T' },
      { id: 'r3-tofu', ko: '두부 1모', en: 'Tofu 1 block', fr: 'Tofu 1 bloc', ja: '豆腐 1丁' },
      { id: 'r3-zucchini', ko: '애호박 1/3개', en: 'Zucchini 1/3', fr: 'Courgette 1/3', ja: 'ズッキーニ 1/3本' },
    ],
    relatedSessionId: 'c4',
    relatedToolId: 't4',
  },
  r4: {
    titleKo: '크렘 카라멜',
    titleEn: 'Creme Caramel',
    titleFr: 'Crème caramel',
    titleJa: 'クレームキャラメル',
...
2. Strain custard
3. Bake low and slow in water bath`,
    markdownFr: `## Points clés
...
2. Filtrer la crème
3. Cuire doucement au bain-marie`,
    markdownJa: `## 重要ポイント
...
3. 湯煎で低温じっくり焼く`,
    ingredients: [
      { id: 'r4-egg', ko: '달걀 4개', en: 'Eggs x4', fr: 'Œufs x4', ja: '卵 4個' },
      { id: 'r4-milk', ko: '우유 400ml', en: 'Milk 400ml', fr: 'Lait 400ml', ja: '牛乳 400ml' },
      { id: 'r4-sugar', ko: '설탕 120g', en: 'Sugar 120g', fr: 'Sucre 120g', ja: '砂糖 120g' },
    ],
    relatedSessionId: 'c3',
    relatedToolId: 't5',
  },
...
3. Braisage long à basse température`,
    markdownJa: `## 重要ポイント
...
3. 低温で長時間ブレゼ`,
    ingredients: [
      { id: 'r5-beef', ko: '소고기 700g', en: 'Beef 700g', fr: 'Bœuf 700g', ja: '牛肉 700g' },
      { id: 'r5-wine', ko: '레드와인 500ml', en: 'Red wine 500ml', fr: 'Vin rouge 500ml', ja: '赤ワイン 500ml' },
      { id: 'r5-mushroom', ko: '버섯 150g', en: 'Mushroom 150g', fr: 'Champignons 150g', ja: 'きのこ 150g' },
    ],
    relatedSessionId: 'c3',
    relatedToolId: 't4',
  },
...
3. Cuire les nouilles et assembler`,
    markdownJa: `## 重要ポイント
...
3. 麺を茹でて組み立てる`,
    ingredients: [
      { id: 'r6-stock', ko: '닭 육수 1.5L', en: 'Chicken stock 1.5L', fr: 'Bouillon de poulet 1,5L', ja: '鶏出汁 1.5L' },
      { id: 'r6-soy', ko: '간장 타레 90ml', en: 'Shoyu tare 90ml', fr: 'Tare shoyu 90ml', ja: '醤油タレ 90ml' },
      { id: 'r6-noodle', ko: '생면 2인분', en: 'Fresh noodles x2', fr: 'Nouilles fraîches x2', ja: '生麺 2人分' },
    ],
    relatedSessionId: 'c2',
    relatedToolId: 't6',
  },
