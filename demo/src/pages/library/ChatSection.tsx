  ...
  return (
    <div className="demo-library-stack">
      ...
      <GlassCard hover={false}>
        ...
        >
          <ChatBubble role="user" meta={formatTimeText('19:22', locale)}>{tr('연어와 레몬으로 뭘 만들 수 있을까?', 'What can I cook with salmon and lemon?', 'Que puis-je cuisiner avec du saumon et du citron ?', 'サーモンとレモンで何を作れる？')}</ChatBubble>
          <ChatBubble role="ai" avatar="P" meta={`${formatTimeText('19:22', locale)} · ${tr('1.2초', '1.2s', '1,2 s', '1.2秒')}`}>
